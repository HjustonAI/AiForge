...
> Auto-maintained registry of all context files.
> Used by compile_context.py --target for auto-selection.
...
Format: | name | relative-path | comma-separated-tags | token-estimate | date |
The compiler reads this table to auto-select files by target keyword.
-->
